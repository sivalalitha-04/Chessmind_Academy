...
import Adminsitesetting from "./pages/Adminsitesetting";
  ...
  return (
    ...
    <div className="App_">
      <Router>
        ...
        <Route path="/acourse/:academyId" element={<Acourse />} />
        <Route path="/encourse" element={<Enrolledcourse/>}/>
        <Route path="/enroll" element={<Enroll/>}/>
        <Route path='/admin/academy' element={<Adminacademy/>}/>
        <Route path='/admin/students' element={<Adminstudent/>}/>
        <Route path='/admin/courses/:academyId' element={<Admincourse/>}/>
        <Route path='/admin/site' element={<Adminsitesetting/>}/>
      </Routes>
      {/* </Adminsidebar> */}
      </Router>
    </div>
